...
public class Readingdata8 extends AppCompatActivity implements ValueEventListener {

    private final FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
    private final DatabaseReference databaseReference = firebaseDatabase.getReference("M8");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_readingdata8);
        ...
        textView = findViewById(R.id.chalo8);
    ...
    private void DisplayTrack() {
        try {
            ...
            Uri uri = Uri.parse("https://www.google.co.in/maps/dir//Ishat e Islam Masjid");
