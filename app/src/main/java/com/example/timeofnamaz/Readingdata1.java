...
public class Readingdata1 extends AppCompatActivity implements ValueEventListener {

    private final FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
    private final DatabaseReference databaseReference = firebaseDatabase.getReference("M1");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_readingdata1);
        ...
        textView = findViewById(R.id.chalo1);
    ...
    private void DisplayTrack() {
        try {
            Uri uri = Uri.parse("https://www.google.co.in/maps/dir//Ramzani Masjid");
