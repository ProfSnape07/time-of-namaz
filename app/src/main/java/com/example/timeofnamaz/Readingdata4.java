...
public class Readingdata4 extends AppCompatActivity implements ValueEventListener {

    private final FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
    private final DatabaseReference databaseReference = firebaseDatabase.getReference("M4");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_readingdata4);
        ...
        textView = findViewById(R.id.chalo4);
    ...
    private void DisplayTrack() {
        try {
            ...
            Uri uri = Uri.parse("https://www.google.co.in/maps/dir//Jama Masjid (Okhla)");
