...
public class Readingdata6 extends AppCompatActivity implements ValueEventListener {

    private final FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
    private final DatabaseReference databaseReference = firebaseDatabase.getReference("M6");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_readingdata6);
        ...
        textView = findViewById(R.id.chalo6);
    ...
    private void DisplayTrack() {
        try {
            ...
            Uri uri = Uri.parse("https://www.google.co.in/maps/dir//Musa Masjid");
