...
public class Readingdata9 extends AppCompatActivity implements ValueEventListener {

    private final FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
    private final DatabaseReference databaseReference = firebaseDatabase.getReference("M9");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_readingdata9);
        ...
        textView = findViewById(R.id.chalo9);
    ...
    private void DisplayTrack() {
        try {
            ...
            Uri uri = Uri.parse("https://www.google.co.in/maps/dir//Char Minar Masjid");
