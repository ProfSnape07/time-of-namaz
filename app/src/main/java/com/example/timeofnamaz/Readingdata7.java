...
public class Readingdata7 extends AppCompatActivity implements ValueEventListener {

    private final FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
    private final DatabaseReference databaseReference = firebaseDatabase.getReference("M7");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_readingdata7);
        ...
        textView = findViewById(R.id.chalo7);
    ...
    private void DisplayTrack() {
        try {
            ...
            Uri uri = Uri.parse("https://www.google.co.in/maps/dir//Masjid Ahle Hadees Complex");
