...
public class Readingdata10 extends AppCompatActivity implements ValueEventListener {

    private final FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
    private final DatabaseReference databaseReference = firebaseDatabase.getReference("M10");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_readingdata10);
        ...
        textView = findViewById(R.id.chalo10);
    ...
    private void DisplayTrack() {
        try {
            Uri uri = Uri.parse("https://www.google.co.in/maps/dir//Masjid Umar");
